...
def build_tree() -> PassiveTree:
    ...
    tree.add_node(PassiveNode(id="deception_c2_r1", node_type=NodeType.LEGENDARY_MEDIUM, column=2, row=1, max_points=1))
    tree.add_node(PassiveNode(id="deception_c2_r2", node_type=NodeType.MICRO,            column=2, row=2, max_points=3))
    tree.add_node(PassiveNode(id="deception_c2_r3", node_type=NodeType.MICRO,            column=2, row=3, max_points=3))
    tree.add_node(PassiveNode(id="deception_c2_r4", node_type=NodeType.MICRO,            column=2, row=4, max_points=3))

    # Column 3 (label: 9)
    tree.add_node(PassiveNode(id="deception_c3_r0", node_type=NodeType.MICRO,  column=3, row=0, max_points=3))
    ...
    tree.add_node(PassiveNode(id="deception_c3_r4", node_type=NodeType.MICRO,  column=3, row=4, max_points=3))
    ...
    tree.add_node(PassiveNode(id="deception_c4_r1", node_type=NodeType.MICRO,  column=4, row=1, max_points=3))
    tree.add_node(PassiveNode(id="deception_c4_r2", node_type=NodeType.MEDIUM, column=4, row=2, max_points=3))
    tree.add_node(PassiveNode(id="deception_c4_r3", node_type=NodeType.MICRO,  column=4, row=3, max_points=3))

    # Column 5 (label: 15)
    tree.add_node(PassiveNode(id="deception_c5_r0", node_type=NodeType.MICRO,  column=5, row=0, max_points=3))
    ...
    tree.add_node(PassiveNode(id="deception_c6_r0", node_type=NodeType.MICRO, column=6, row=0, max_points=3))
    tree.add_node(PassiveNode(id="deception_c6_r1", node_type=NodeType.MICRO, column=6, row=1, max_points=3))
    tree.add_node(PassiveNode(id="deception_c6_r3", node_type=NodeType.MICRO, column=6, row=3, max_points=3))
    tree.add_node(PassiveNode(id="deception_c6_r4", node_type=NodeType.MICRO, column=6, row=4, max_points=3))
