...
def build_tree() -> PassiveTree:
    ...
    # Column 1 (label: 3)
    tree.add_node(PassiveNode(id="machinist_c1_r0", node_type=NodeType.MICRO,  column=1, row=0, max_points=3))
    ...
    tree.add_node(PassiveNode(id="machinist_c1_r4", node_type=NodeType.MICRO,  column=1, row=4, max_points=3))

    # Column 2 (label: 6)
    tree.add_node(PassiveNode(id="machinist_c2_r0", node_type=NodeType.MICRO,            column=2, row=0, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c2_r1", node_type=NodeType.LEGENDARY_MEDIUM, column=2, row=1, max_points=1))
    tree.add_node(PassiveNode(id="machinist_c2_r2", node_type=NodeType.MICRO,            column=2, row=2, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c2_r3", node_type=NodeType.MICRO,            column=2, row=3, max_points=3))
    ...
    tree.add_node(PassiveNode(id="machinist_c3_r0", node_type=NodeType.MICRO,  column=3, row=0, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c3_r2", node_type=NodeType.MEDIUM, column=3, row=2, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c3_r3", node_type=NodeType.MICRO,  column=3, row=3, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c3_r4", node_type=NodeType.MICRO,  column=3, row=4, max_points=3))
    ...
    tree.add_node(PassiveNode(id="machinist_c4_r2", node_type=NodeType.MEDIUM, column=4, row=2, max_points=3))
    ...
    # Column 5 (label: 15)
    tree.add_node(PassiveNode(id="machinist_c5_r0", node_type=NodeType.MICRO,  column=5, row=0, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c5_r1", node_type=NodeType.MICRO,  column=5, row=1, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c5_r2", node_type=NodeType.MEDIUM, column=5, row=2, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c5_r3", node_type=NodeType.MICRO,  column=5, row=3, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c5_r4", node_type=NodeType.MICRO,  column=5, row=4, max_points=3))

    # Column 6 (label: 18) — rows 0, 1 only
    tree.add_node(PassiveNode(id="machinist_c6_r0", node_type=NodeType.MICRO, column=6, row=0, max_points=3))
    tree.add_node(PassiveNode(id="machinist_c6_r1", node_type=NodeType.MICRO, column=6, row=1, max_points=3))
