...
function App() {
  ...
  const startNewBuild = () => {
    const payload = {
      ...
      traitId: null, traitSlotLevels: [1, 1, 1, 1], advancedTraitSelections: [], traitSkillSupports: [], licoricePreparedSkill: null, elixirIngredients: {},
