...
export const AREA_FIELDS: Record<AreaKey, string[]> = {
  ...
  gear: ['gear'],
  skills: ['skills'],
  trait: ['traitId', 'traitSlotLevels', 'advancedTraitSelections', 'traitSkillSupports'],
...
export const DEFAULT_AREA_SNAPSHOT: Record<AreaKey, AreaSnapshot> = {
  ...
  gear: { gear: [] },
  skills: { skills: [] },
  trait: { traitId: null, traitSlotLevels: [1, 1, 1, 1], advancedTraitSelections: [], traitSkillSupports: [] },
