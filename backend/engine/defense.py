...
from engine.derive import _additional_pool_factor, local_gear_defense_sources, local_gear_defense_total_from_rows
...
def calculate_defense(source: BuildSource, reservation: dict | None = None) -> DefenseResult:
    ...
    return DefenseResult(
        ...
        es_flat=source.total("max_energy_shield_flat") + local_gear_defense_total_from_rows(source, "energy_shield_gear_flat", local_gear_sources["energy_shield"]),
        es_inc=source.total("max_energy_shield_inc"),
        es_additional=_additional_pool_factor(source, ["max_energy_shield_additional"]) - 1.0,
        armor_flat=source.total("armor_flat") + local_gear_defense_total_from_rows(source, "armor_gear_flat", local_gear_sources["armor"]),
        ...
        evasion_flat=source.total("evasion_flat") + local_gear_defense_total_from_rows(source, "evasion_gear_flat", local_gear_sources["evasion"]),
